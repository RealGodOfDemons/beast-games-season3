...
import PaymentProofUpload from "@/components/paymentProof";
...
/* ------------------ CryptoPayment Component (inlined) ------------------ */
...
const Payment = () => {
      ...
      if (user) {
        ...
        if (profile?.has_paid_entry) {
          toast({
            ...
            description: "You have already paid the entry fee and can play all games.",
          });
          navigate("/games");
        }
      }
  ...
  const handleCryptoPaymentInitiated = () => {
    toast({
      ...
      description: "Follow the instructions to complete your cryptocurrency payment"
    });
  };
  ...
  const handleCardPayment = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: error.message === "Edge Function returned a non-2xx status code" ? "Something went wrong, please try crypto payment" : error.message || "Unable to process payment. Please try again.",
        variant: "destructive",
      });
    } finally {
      setProcessing(false);
    ...
    return (
      <div className="text-center space-y-8 py-16">
        ...
        <div className="space-y-4">
          <h1 className="text-4xl font-bold beast-gradient">Payment Required</h1>
          <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
            You need to sign in before making a payment to participate in MrBeast Games.
          </p>
  ...
  <Card className="border-crypto-border bg-gradient-to-br from-crypto-background to-background">
    ...
    <CardContent className="space-y-4">
      <p className="text-sm text-muted-foreground">
        ...
        proof of the transaction below. Our team will review it and confirm 
        your entry.
      </p>
          ...
          <div className="flex items-start space-x-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground">
                ...
                We never store your card details, and all transactions are processed 
